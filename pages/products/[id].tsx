...
const ProductDetail: React.FC<Props> = ({ product }) => {
  console.log("product from inside", product);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <div className="flex items-center">
              ...
              <button className="px-4 py-2 ml-6 bg-white text-gray-800 text-sm font-semibold rounded-md shadow-md hover:shadow-lg transform hover:scale-105 transition duration-300 ease-in-out">
                Add to Cart
              </button>
            </div>
          </div>
